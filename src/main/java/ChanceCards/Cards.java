...
public class Cards {
    ...
    private void createCards(){
        ...
        cardArray[11] = new Card(10,"moveBrownOrYellow","The player moves to a brown or yellow field. If it's not owned by anyone, gets it for free. Otherwise pay the owner!");
